<div class="d-flex gap-2 mb-3">
    <a class="btn btn-success" href="<?= e(url('/reportes/export?format=excel')) ?>">Exportar Excel</a>
    <a class="btn btn-primary" href="<?= e(url('/reportes/export?format=word')) ?>">Exportar Word</a>
    <a class="btn btn-warning" href="<?= e(url('/reportes/export?format=ppt')) ?>">Exportar PowerPoint</a>
</div>
